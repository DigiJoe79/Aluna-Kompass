...
- **URL-Teil.** Hat die Sammlung Einträge mit eigener Seite — jede Meldung
  ...
  Leerzeichen, eindeutig. Kompass schlägt ihn aus dem Titel vor; ändern Sie
  ihn nach dem Publizieren nicht mehr ohne Grund, denn er ist die Adresse,
...
- **Höchstzahl.** Ist sie erreicht, ist „Neu“ gesperrt, bis ein Eintrag
  geht.

## Einträge entfernen

Ein Eintrag lässt sich löschen. Inhalte der Webseite sind Arbeitsmaterial,
keine Rechenschaft — deshalb darf das, anders als in der Akte. Der Löschvorgang
selbst steht im Änderungsprotokoll: was verschwindet, ist der Inhalt, nicht
die Tatsache, dass jemand ihn entfernt hat. Ein Bild, das der Eintrag benutzt
hat, bleibt in der Mediathek.

## Auf die Seite

Änderungen an Sammlungen sind sofort gespeichert, aber erst nach dem nächsten
[Publizieren](publizieren.md) im Internet. Bis dahin sehen Sie sie in der
Vorschau.
