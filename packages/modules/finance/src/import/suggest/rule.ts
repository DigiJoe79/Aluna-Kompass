/**
 * Trifft eine Regel einen Kontoumsatz? Rein, ohne Datenbank und ohne Import
 * aus `@kompass/*` oder `../` (F5; Wächter `suggest-purity.test.ts`), damit
 * dieselbe Prüfung im Dienst, in der Vorschau und später im Browser läuft.
 */
