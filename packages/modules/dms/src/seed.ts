...
export async function seedDms(deps: Deps, ctx: CallContext): Promise<void> {
  ...
  // Mit Textebene: Der Worker liest sie, und die Volltextsuche findet
  // „Tierschutzes“, obwohl es im Betreff nicht vorkommt.
  const samplePdf = textPdf([
    'Finanzamt Musterstadt',
    'Steuernummer 12/345/67890',
    '',
    'Freistellungsbescheid 2024 bis 2026',
    '',
    'Der Verein verfolgt ausschließlich und unmittelbar gemeinnützige Zwecke',
    'im Sinne der Abgabenordnung, nämlich die Förderung des Tierschutzes.',
    'Er ist von der Körperschaftsteuer und der Gewerbesteuer befreit.',
  ]);
