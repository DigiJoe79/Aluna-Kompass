...
describe('projects module', () => {
  ...
  it('names a tool for each permission and keeps the tool names of the core era', () => {
    ...
    expect(names).toEqual(['project_create', 'project_delete', 'project_deletion_preview', 'project_get', 'project_set_published', 'project_update', 'projects_list', 'projects_reorder']);
