...
describe('animals mcp tools', () => {
  it('creates and lists through the tool handlers with the caller context', async () => {
    ...
    expect(Object.keys(tools).sort()).toEqual(['animals_create', 'animals_delete', 'animals_deletion_preview', 'animals_get', 'animals_list', 'animals_set_photos', 'animals_set_published', 'animals_set_status', 'animals_set_story', 'animals_update']);
