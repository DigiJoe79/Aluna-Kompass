...
export const ANIMALS_MCP_TOOLS: McpToolDefinition[] = [
  ...
  t('animals_update', 'Update an animal profile. Requires animals.manage. Localized fields are replaced as a whole map; to change one locale use translations_set.', animalUpdateSchema, (deps, ctx, args) => updateAnimal(deps, ctx, args), updateAnimal),
  ...
  t('animals_set_story', 'Set adoption success story of an adopted animal. Requires animals.manage. Localized fields are replaced as a whole map; to change one locale use translations_set.', animalStorySchema, (deps, ctx, args) => setAnimalStory(deps, ctx, args), setAnimalStory),
