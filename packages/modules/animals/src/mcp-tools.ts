...
import { z } from 'zod';
import { animalCreateSchema, animalDeleteSchema, animalDeletionPreview, animalPhotosSchema, animalStatusSchema, animalStorySchema, animalUpdateSchema, createAnimal, deleteAnimal, getAnimal, listAnimals, setAnimalPhotos, setAnimalPublished, setAnimalStatus, setAnimalStory, updateAnimal } from './service';
...
export const ANIMALS_MCP_TOOLS: McpToolDefinition[] = [
  ...
  t('animals_update', 'Update an animal profile. Requires animals.manage. Localized fields are replaced as a whole map; to change one locale use translations_set. Pass expectedVersion (the updatedAt you last read) to be rejected with staleVersion instead of overwriting a change made in between.', animalUpdateSchema, (deps, ctx, args) => updateAnimal(deps, ctx, args), updateAnimal),
  ...
  t('animals_set_story', 'Set adoption success story of an adopted animal. Requires animals.manage. Localized fields are replaced as a whole map; to change one locale use translations_set. Pass expectedVersion (the updatedAt you last read) to be rejected with staleVersion instead of overwriting a change made in between.', animalStorySchema, (deps, ctx, args) => setAnimalStory(deps, ctx, args), setAnimalStory),
