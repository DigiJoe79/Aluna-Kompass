...
export const animals = sqliteTable(
  'animals',
  {
    ...
    birthText: localizedColumn('birth_text', 'animals'),
    sizeCm: integer('size_cm').notNull().default(0),
    sizeText: localizedColumn('size_text', 'animals'),
    ...
    summary: localizedColumn('summary', 'animals'),
    body: localizedColumn('body', 'animals'),
...
export const animalStories = sqliteTable('animal_stories', {
  ...
  quote: localizedColumn('quote', 'animal_stories'),
