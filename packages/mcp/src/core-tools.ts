import {
  activateTheme, addLocale, assignRole, createMediaFolder, createProject, createRole, createUser, deleteMediaAsset, deleteMediaFolder, getAuditEntry, getProject, listDocuments, listLocales, listMediaAssets, listModules, listProjects,
