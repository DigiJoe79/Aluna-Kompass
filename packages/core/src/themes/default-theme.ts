...
export const DEFAULT_THEME: Theme = {
  ...
  tokens: {
    ...
    'color-final': { light: '#41525C', dark: '#9FB2BE' },
    'color-final-bg': { light: '#E7EBED', dark: '#222A31' },
    'color-agent': { light: '#5B4A86', dark: '#B3A6DE' },
    'color-agent-bg': { light: '#EDEAF7', dark: '#262040' },
    'color-amount-out': { light: '#6B4A3A', dark: '#D3AE9B' },
    'color-key-bg': { light: '#FFFFFF', dark: '#2C3138' },
    'color-key-ink': { light: '#3C4249', dark: '#C7CACE' },
