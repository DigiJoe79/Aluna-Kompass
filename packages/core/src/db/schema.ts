...
/**
 * Die Startseite je Nutzer (Spec 2026-09-17, § 4). Kein Eintrag heißt Vorgabe;
 * was in `tiles` steht, ist an. Nutzereinstellung, kein Vereinsvorgang —
 * löschbar (Löschregel `dashboardLayout`).
 */
