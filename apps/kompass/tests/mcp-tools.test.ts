...
const WITHOUT_TOOL: Record<string, string> = {
  ...
  'dms.toRecord': 'Innenleben der Dienste; verlässt mit Task 8 die Exporte der Akte.',
  'dms.relationsFor': 'Innenleben von toRecord; verlässt mit Task 8 die Exporte der Akte.',
