 ...
 * wird `docs/intern/` (Specs, Pläne, Design-Handoff): Das sind Protokolle
 * abgeschlossener Arbeit — die schreibt man nicht nachträglich um, nur damit
 * ein Test grün wird. Im öffentlichen Repo liegt das Verzeichnis ohnehin nicht.
 */
